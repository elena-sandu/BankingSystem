...
/**
 * Implements a command to generate detailed spending reports for a specified bank account over a given time period.
 * This report provides insights into transactions specifically related to commerciants, filtering out transactions
 * that do not meet the criteria, and is not applicable to savings accounts.
 */
public class SpendingsReport implements Commands {
    ...
    /**
     * Creates a spending report for the specified account.
     * Validates that the account is eligible for such a report shows transactions
     * related to commerciants within the specified timeframe.
        ...
        if (user != null && account != null) {
            ...
            if (account.hasInterestRate() == 1) {
                ...
                if (hasCommerciants > 0) {
                    ...
                    //calculate how much money the user spent at the commerciants in that period of time
